...
\begin{equation}
    \frac{d\tilde{\varphi}}{d\varphi} = \left[ \frac{6M}{\sqrt{\beta \varphi^2  +\gamma \phi_0 \varphi +\alpha \phi^2_0}} \right]
\end{equation}
gives, 
...
\begin{equation}
    V(\tilde{\varphi}) = \frac{\mu^2 \beta^2}{2} \left[ \frac{\frac{\gamma}{2} - \sqrt{\alpha \beta - \frac{\gamma^2}{4}}\sinh(\frac{\sqrt{\beta}\tilde{\varphi}}{6M}+C)}{\gamma^2-4\gamma\sqrt{\alpha \beta - \frac{\gamma^2}{4}}\sinh(\frac{\sqrt{\beta}\tilde{\varphi}}{6M}+C) +4(\alpha \beta - \frac{\gamma^2}{4})\cosh^2(\frac{\sqrt{\beta}\tilde{\varphi}}{6M}+C)}\right]^2
\end{equation}
...
\begin{equation}
    V(\tilde{\varphi}) = \frac{\mu^2 \beta^2}{2} \left[ \frac{\frac{\gamma}{2} - D \sinh(X)}{\gamma^2-4\gamma D \sinh(X) +4D\cosh^2(X)}\right]^2
\end{equation}
