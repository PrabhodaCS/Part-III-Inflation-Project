...
The $m$ in this equation is just the coefficient of the quadratic term in the potential. It is there to ensure that the potential has a quadratic minima suitable for reheating, It is not exactly the mass of the field. \footnote{The concept of mass is tricky to define in deSitter space. The mass of a particle is given by one of its eigenvalues of the Casimir operators of the Poincaré group, the full symmetry group of standard Minkowski space. In deSitter space, this is, however, not the symmetry group we are working with here, as a simple look at the de Sitter metric \ref{1} will show that it does not admit timelike Killing vectors, unlike Minkowski.}
