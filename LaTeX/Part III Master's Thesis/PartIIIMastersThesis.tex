...
\begin{equation}
    \epsilon_H = - M_p^2 \left(\frac{\dot{H}}{H^2} \right) \approx \frac{M_p^2}{2} \left(\frac{V,_\varphi}{V}\right)^2
\end{equation}
...
\end{equation}
\end{widetext}
Denoting $\frac{C\tilde{\varphi}}{M_p}$ as $\theta$, the first and second derivatives of this potential is given by:
\begin{widetext}
    \begin{equation} 
