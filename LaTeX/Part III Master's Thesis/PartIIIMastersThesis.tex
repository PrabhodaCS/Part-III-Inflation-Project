...
\DeclareTOCStyleEntry[numwidth=20pt,linefill=\bfseries\TOCLineLeaderFill]{tocline}{section}
\DeclareTOCStyleEntry[entryformat=\textit,numwidth=10pt,linefill=\TOCLineLeaderFill]{tocline}{subsection}
\DeclareTOCStyleEntry[entryformat=\textit,numwidth=10pt,linefill=\TOCLineLeaderFill]{tocline}{subsubsection}
...
\begin{figure}[htb]
  \centering
  % First sub‐figure: Potential vs Field ----------------------------
  {%
    \includegraphics[width=1.0\columnwidth]{../../Python/results/potential.png}%
  }%
  \\[1ex]  % <-- force a small vertical gap, then place next subfloat below
  % Second sub‐figure: Phase Space Portrait -------------------------
  {%
