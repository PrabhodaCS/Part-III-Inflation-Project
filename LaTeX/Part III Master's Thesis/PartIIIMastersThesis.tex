...
\usepackage{tocloft}  % you can also use tocbasic, but tocloft gives \cftsecnumwidth
\setlength{\cftsecnumwidth}{3em}    % widen for section numbers
\setlength{\cftsubsecnumwidth}{2em} % widen for subsections, if any
% ───────────────────────────────
\usepackage{cleveref}
